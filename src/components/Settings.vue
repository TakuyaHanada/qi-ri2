      ...
      <v-flex xs12>
        <v-card>
          <v-list two-line subheader>
            <v-subheader>アプリ情報</v-subheader>

            <v-list-tile avatar>
              <v-list-tile-content>
                <v-list-tile-title>最終更新日</v-list-tile-title>
                <v-list-tile-sub-title>2019/04/17</v-list-tile-sub-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile avatar>
              <v-list-tile-content>
                <v-list-tile-title>バージョン</v-list-tile-title>
